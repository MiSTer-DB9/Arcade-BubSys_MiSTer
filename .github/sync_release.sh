...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-BubSys_MiSTer.git"
CORE_NAME=(Arcade-BubSys)
...
UPSTREAM_CORE_NAME=(Arcade-BubSys)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(BubSys.qpf)
COMPILATION_OUTPUT=(output_files/BubSys.rbf)
